...
train_samples, test_samples = tools.generate_data(V)
...
# Training
trainer = tools.Trainer(model, lr, l1_coef, wd, dropout, iters)
trainer.train(V, n_max, n_batch, train_samples, test_samples)